...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      ...
      <main>
        <Tabs defaultValue="hero" orientation="vertical" className="flex flex-col md:flex-row gap-6 md:gap-10">
          <TabsList className="flex flex-row justify-start overflow-x-auto md:flex-col md:justify-start md:w-48 md:overflow-x-visible -mx-4 px-4 md:-mx-0 md:px-0 md:border-r md:pr-6 bg-transparent">
            <TabsTrigger value="hero" className="justify-start px-3">Hero</TabsTrigger>
            <TabsTrigger value="about" className="justify-start px-3">About</TabsTrigger>
            <TabsTrigger value="projects" className="justify-start px-3">Projects</TabsTrigger>
            <TabsTrigger value="gallery" className="justify-start px-3">Gallery</TabsTrigger>
            <TabsTrigger value="contact" className="justify-start px-3">Contact</TabsTrigger>
            <TabsTrigger value="settings" className="justify-start px-3">Settings</TabsTrigger>
          </TabsList>
